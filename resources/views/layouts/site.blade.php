            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li><a class="nav-link nav_item" href="{{route('home.home')}}">Trang chủ</a></li>
                            <li><a class="nav-link nav_item" data-toggle="modal" data-target="#modal-lg" href="#nhap">Hướng dẫn chọn size</a></li>

                            <li class="dropdown dropdown-mega-menu">
                                <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Danh mục sản phẩm</a>
                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        @if (!Auth::guard('khachhang')->user())
                        <li><a class="nav-link nav_item" href="{{route('home.index')}}">Đăng nhập</a></li>
                        @endif
                        @if (Auth::guard('khachhang')->user())
                        ...
                        <li class="dropdown cart_dropdown">
                            ...
                            <div class="cart_box dropdown-menu dropdown-menu-left">
                                <ul class="cart_list">
                                    ...
                                    <li class="text-right">
                                        <a href="{{route('get.donhang',Auth::guard('khachhang')->user()->id)}}">Đơn hàng của tôi</a>
                                    </li>
                                    <li class="text-right">
                        ...
                        <li class="dropdown cart_dropdown">
                            <a class="nav-link cart_trigger" href="" data-toggle="modal" data-target="#modal-danger"><i class="fas fa-search"></i> Tìm kiếm</a>
