      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
            ...
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                ...
                <a href="{{route('home.index')}}">
                  <img src="{{url('public/spica')}}/images/ntp.png" alt="logo" width="80px">
                </a>
              </div>
              <h4>Xin chào!</h4>
          ...
          <div class="col-lg-6 login-half-bg d-none d-lg-flex flex-row">
            <img src="{{url('public/spica')}}/images/auth/ntp.jpg" height="870px">
            
          </div>
          <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy; Nguyễn Tấn Phát  All rights reserved.</p>
        </div>
      </div>
