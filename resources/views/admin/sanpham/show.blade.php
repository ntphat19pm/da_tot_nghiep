...
<div class="card" >
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <img class="rounded mx-auto d-block" src="{{url('public/uploads')}}/{{$data->anh}}"  width="300px"/>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group mt-5">
                    <img class="rounded mx-auto d-block" src="{{url('public/uploads')}}/{{$data->anh1}}"  width="300px"/>
                </div>
            </div>
