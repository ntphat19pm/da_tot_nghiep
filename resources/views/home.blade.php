...
<br><img src="{{url('public/feane')}}/images/nen.jpg" height="10%" alt="">
        ...
        <div class="row">
          ...
          @else
            <div class="col-md-6  ">
              <div class="box ">
                <div class="img-box">
                  <img src="{{url('public/uploads')}}/{{$item->hinhanh}}" alt="">
                </div>
                                  ...
                                  @else
                                    ...
                                    <div class="product_img">
                                        <a href="{{route('home.chitiet',$item->id)}}">
                                            <img class="img-fluid" src="{{url('public/uploads')}}/{{$item->anh}}" alt="product_img">
                                        </a>
